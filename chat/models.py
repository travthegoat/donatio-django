...
class Chat(models.Model):
    ...
    donor = models.ForeignKey('accounts.User', on_delete=models.CASCADE, related_name='donor_chats')
    organization = models.ForeignKey('organizations.Organization', on_delete=models.CASCADE, related_name='organization_chats')
...
class ChatMessage(models.Model):
    ...
    donor = models.ForeignKey('accounts.User', on_delete=models.CASCADE, related_name='donor_messages', null=True, blank=True)
    organization = models.ForeignKey('organizations.Organization', on_delete=models.CASCADE, related_name='organization_messages', null=True, blank=True)
